...
function Video() {
    ...
    return (
        <div id="firstDiv">
            ...
            {/* main body */}
            <video src={VD} autoPlay loop muted id="VD" />
            ...
            <h1 id="text" style={{color:"#03043b"}}>Tested for Toughness: Unmatched Strength of Shri VR E-Bikes</h1>
            <div className="videoDiv">
                <video src={video} id="video"   controls />
                <video src={video3} id="video"   controls />
                <video src={video4} id="video"   controls />
                <video src={video5} id="video"   controls />
